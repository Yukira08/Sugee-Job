...
const Step = () => {
  return (
    <div class="container-fluid step my-5">
      ...
      <div class="row mt-5 mx-5">
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
          <div class="text-center">
            ...
            <p>From Product, Engineer, Operation, HR, you name it!</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
          <div class="text-center">
            ...
            <p>Set up your profile ans job preference, so we can find you the most suitable job for you, quickyl!</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
          <div class="text-center">
            ...
            <p>Just One click away from getting your dream job!</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
          <div class="text-center">
            ...
            <p>Yeah, we said it, Only one click away, right?</p>
          </div>
        </div>
      </div>
    </div>
